...
const ticket_cancel_buttons = document.getElementById('cancel-or-download-ticket');
const download_ticket_button = document.getElementById('download-ticket-button');
